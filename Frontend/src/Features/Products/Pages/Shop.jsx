  ...
  return (
    <div className="min-h-screen bg-background text-foreground py-10 px-4 max-w-[1400px] mx-auto">
      ...
      <div className="flex gap-8">
        ...
        <div className="hidden md:block w-64 flex-shrink-0 sticky top-24 self-start pr-1 space-y-6">
            ...
            {isMobileFilterOpen && (
              <>
                ...
                <motion.div
                  ...
                  className="fixed top-0 right-0 z-[1201] bg-background w-[85%] max-w-sm h-full p-6 overflow-y-auto scrollbar-hide shadow-2xl border-l border-border-theme md:hidden"
                >
                  <FilterSidebarContent {...sidebarProps} />
                </motion.div>
              </>
