...
export const config = {
    ...
    VAPID_PUBLIC_KEY: process.env.VAPID_PUBLIC_KEY || "BNU7XYJYq2-LMpb8UTDWSmVfJspLJRks8jddINJG4cue7EnpK1dWLeLsKVjh7msAsr80KZe2BolGwmsQ91EiBMA",
    VAPID_PRIVATE_KEY: process.env.VAPID_PRIVATE_KEY || "cHvuZfXxYe1EiJzPU78tmlj6tDHVBOblLRusCjBL_uQ",
    VAPID_SUBJECT: process.env.VAPID_SUBJECT || "mailto:support@scapegoat.com",
